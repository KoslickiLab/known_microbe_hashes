...
cmd=(
    ...
    --input-root "/scratch/dmk333_new/known_microbe_hashes/Logan_plasmids/sketches"
    --out-root "/scratch/dmk333_new/known_microbe_hashes/Logan_plasmids/data/parquet_dumps"
    --glob "*.sig.zip"
    --mod 64
    --workers 64
